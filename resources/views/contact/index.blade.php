...
@section('content')
  ...
  <main>
			...
			<div class="tm-container-inner-2 tm-contact-section">
				<div class="row">
					<div class="col-md-6">
						<form action="/message" method="POST" class="tm-contact-form" id="messages">
					        <div class="form-group">
					          <input type="text" name="name" class="form-control" placeholder="Name" value="{{ old('name') }}" />
					          	<p class="error-message" id="name"></p>
					        ...
					        <div class="form-group tm-d-flex">
					          <button type="submit" class="tm-btn tm-btn-success tm-btn-right" id="msgBtn">
					            Send
					          </button>
					        </div>
						</form>
